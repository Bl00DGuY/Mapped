...
data.basenodes.MapsWithExplicitFloors = {
	["Orgrimmar"] = {
		...
		-- 3-way west tunnel
		"Orgrimmar/2 32,83 @cleft_sw <title:Cleft of Shadow tunnel> <region:cleftofshadow_sw>",
		"@cleft_sw -x- Orgrimmar/1 45.90,66.94 <title:Cleft of Shadow entrance>",
		"@cleft_sw -x- Orgrimmar/1 42.09,61.03 <title:Cleft of Shadow entrance>",
		"@cleft_sw -x- Orgrimmar/2 35.85,79.06 <title:Cleft of Shadow tunnel>",
		"Orgrimmar/2 70.52,19.53 @cleft_ne <title:Cleft of Shadow tunnel> <region:cleftofshadow_ne>",
		"@cleft_ne -x- Orgrimmar/1 55.12,51.43 <title:Cleft of Shadow entrance>",
		"@cleft_ne -x- Orgrimmar/2 67.37,36.52 <title:Cleft of Shadow exit>", -- s-shaped east tunnel
	},
	["Dalaran"] = { --
		-- Underbelly, a few entries
		"Dalaran/1 34.89,45.42 -x- Dalaran/2 34.28,43.57 {template:tunnel}",
		"Dalaran/1 60.28,47.77 -x- Dalaran/2 64.16,48.00 {template:tunnel}",
		--[[
		...
		--]]
		"Dalaran/1 48.30,32.54 <radius:2> <title:Dalaran Well> -to- Dalaran/2 62.74,48.83 {cost:5}", -- well jump!
	},
...
data.basenodes.advanced = {
	...
	{"REGION",name="underbelly",mapzone=504,zonematch="*/*/*/The Underbelly",nofly=1},
	...
	{"REGION",name="cleftofshadow_sw",center="Orgrimmar/2 31,82",radius=50, dark=1 },
	{"REGION",name="cleftofshadow_ne",center="Orgrimmar/2 70,23",radius=50, dark=1 },
...
data.basenodes.borders = {
	[1] = {
		...
		"Un'Goro Crater,50.4,7.9 -x- Sholazar Basin,40.4,83.0 (B:PORTAL) {template:portalauto} {cond:PlayerCompletedQuest(12613)}",
...
-- == PORTALS == --
	...
	-- PANDARIA
		...
		"Dread Wastes,75.09,21.25 -x- Vale of Eternal Blossoms,14.21,76.79 (B:PORTAL) {template:pandarope}", -- (click the Climbing Rope to either climb up or jump down the cliff)
	...
	-- DALARAN PORTALS:
		...
		"Dalaran 25.5,51.4 -to- Tanaris/17 54.6,28.3 @cot_from_dala (B:PORTAL) {cond:LibRover.cfg.use_cot or (ZGV and ZGV:GetReputation('Keepers of Time').standing>=5)}",
...
data.basenodes.inns = {
	...
	['Borean Tundra']={
		{name="Valiance Rest",faction="A",npc="James Deacon",npcid=25245,x=58.2,y=68.0},
...
data.portkeys = { -- smile if you're a muggle
	...
	{spell=556, destination="HEARTH", is_astral=1, link={mode="spell",cost=30}}, -- Astral Recall

	{item=63352, destination="@!sw_tp_dst", link={cooldown=28800}}, -- Shroud of Cooperation
	...
	--{item=30542, destination="Netherstorm 32,63", cooldown=14400, -- Dimensional Ripper - Area 52 Engineering >=350 Goblin
	--{item=18984, destination="Winterspring xx,yy", cooldown=14400, -- Dimensional Ripper - Everlook Engineering >=260 Goblin
	...
	--{item=63378, destination="Tol Barad xx,yy", cooldown=14400}, -- Baradin's Wardens Tabard  Horde
	--{item=63379, destination="Tol Barad xx,yy", cooldown=14400}, -- Hellscream's Reach Tabard  Alliance
}